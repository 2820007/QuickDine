...
import { createOwnerRestaurant, getOwnerBookings, getOwnerRestaurant, updateBookingsStatus, updateOwnerRestaurant } from "../controllers/ownerController.js";
...
ownerRouter.put("/bookings/:id/status",updateBookingsStatus)
